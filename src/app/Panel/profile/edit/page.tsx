...
import PageTitle from "../../../../components/layout/Container/PageTitle";
...
const EditProfilePage: FC = () => {
      ...
      <Container>
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-smoke-600 dark:text-smoke-400">Loading profile...</p>
          </div>
        </div>
      </Container>
    );
  ...
  return (
    <Container size="md">
      ...
      <PageTitle icon={IconUser} title="Edit Profile" />
